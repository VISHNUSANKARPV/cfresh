...
import 'package:free_lance/app/modules/auth/signup/views/signup_view.dart';
              ...
              Padding(
               ...
               TextButton(
                style: ButtonStyle(
                  ...
                  shape: MaterialStateProperty.all(const RoundedRectangleBorder(side: BorderSide(color: AppColor.accent,width: 1),borderRadius: BorderRadius.all(Radius.circular(10))))
                ),
              onPressed: () {
